...
void Renderer::LoadResources() {
  ...
  m_Bunny->shader = &m_BlinnPhongShader;  // Blinn-Phong shader for main pass
  ...
  m_Plane->shader = &m_BlinnPhongShader;  // Blinn-Phong shader for main pass
}

void Renderer::DrawRenderable(const Renderable& renderable) {
  ShaderUniforms uniforms;
  BuildUniforms(renderable, uniforms);
